...
let mobile_open_btn = document.querySelector(
  "#headerWrap #header .mobile-open span"
);
let mobile_gnb = document.querySelectorAll(
  ".mobile-menu > #mobile-gnb > li >a"
);
let mobile_snb = document.querySelectorAll(
  ".mobile-menu > #mobile-gnb > li >.snb"
);
let moblie_open = document.querySelector(".mobile-open");

/* mobile-open버튼을 클릭시 이벤트함수 */
let toggle_mobile_menu = () => {
  let mobile_open_btn_state =
    mobile_open_btn.classList.contains("mobile_open_click");
